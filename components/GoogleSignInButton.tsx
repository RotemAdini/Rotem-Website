 ...
 *
 * A plain <form> posting to a Server Action rather than an onClick handler: it
 * works without client-side JavaScript, needs no hydration, and keeps the
 * whole OAuth start on the server where the PKCE cookie belongs.
 */
...
/** Google's mark, inline so it needs no network request and no extra asset. */
function GoogleMark() {
  return (
