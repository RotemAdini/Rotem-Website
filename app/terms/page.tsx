      ...
      <div className="container legal-shell">
        ...
        <div className="legal-content">
          ...
          <section className="legal-section" id="tou-delivery">
            ...
            <p>סעיף זה יחול כאשר תיפתח הרכישה המקוונת. נכון להיום, כאמור בסעיף 5, לא ניתן לרכוש באתר.</p>
            <p>עם פתיחת הרכישה: לאחר השלמת התשלום יישלח לכתובת האימייל שסופקה קישור לגישה למשחק שנרכש. אין צורך להוריד או להדפיס דבר — הגישה מתבצעת ישירות דרך הקישור והדפדפן.</p>
          </section>
