      ...
      <div className="container legal-shell">
        ...
        <div className="legal-content">
          ...
          <section className="legal-section" id="ac-limits">
            ...
            <ul>
              <li>
                <strong>טפסי ההרשמה בעמודי המשחקים</strong> נשלחים לשירות דיוור חיצוני. המבנה שלהם באתר הונגש
                כמו שאר הטפסים — תוויות, הודעות שגיאה והעברת מיקוד לשדה הראשון שדורש תיקון — אבל שמות השדות
                נקבעים על ידי אותו שירות, וגם עמוד האישור שמוצג אחרי השליחה מגיע ממנו ואינו בשליטתי. ייתכנו בו
                פערי נגישות. אפשר תמיד לפנות אליי ישירות דרך עמוד <Link href="/contact">צור קשר</Link> במקום
                להשתמש בטופס.
              </li>
              <li>
          ...
          <section className="legal-section" id="ac-tools">
            ...
            <p>
              ...
              נשמרות בדפדפן שלכם בלבד, וחלות כבר בטעינת העמוד הבא — בלי הבהוב של התצוגה הרגילה לפניהן.
            </p>
            <p>
              בגלישה במקלדת הכפתור הוא העצירה השנייה בעמוד, מיד אחרי הקישור &quot;דילוג לתוכן הראשי&quot;, כדי
              שלא יהיה צורך לעבור את כל העמוד כדי להגיע אליו. <span lang="en">Esc</span> סוגר את החלונית ומחזיר
              את המיקוד לכפתור.
            </p>
            <p>
