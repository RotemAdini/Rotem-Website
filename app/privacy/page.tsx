      ...
      <div className="container legal-shell">
        ...
        <div className="legal-content">
          ...
          <section className="legal-section" id="pp-favorites">
            ...
            <p>
              <strong>מיזוג בהתחברות הראשונה:</strong> כשמתחברים לראשונה בדפדפן שכבר שמר פריטים כאורח, אותם פריטים
              מצורפים אוטומטית לחשבון. משמעות הדבר היא שפריטים שנשמרו קודם לכן באופן אנונימי הופכים לחלק מהמידע
          ...
          <section className="legal-section" id="pp-cookies">
            ...
            <p>
              בנוסף, האתר שומר מידע <strong>באחסון המקומי של הדפדפן (localStorage)</strong>. מידע זה נשאר במכשיר
              שלכם ואינו נשלח לשרתי האתר:
            </p>
            <ul>
